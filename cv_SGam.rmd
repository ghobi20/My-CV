...
#CV <- create_CV_object(
#  data_location = "https://docs.google.com/spreadsheets/d/1NqKZJyykZ1W",  
#  pdf_mode = params$pdf_mode
#)

CV <- create_CV_object(
  data_location = "https://docs.google.com/spreadsheets/d/1yvcm0yo2V_AXBF5vXaRpv62sqkAuyXtl69BfNw4cA7I/edit?usp=sharing",  
  pdf_mode = ifelse(exists("params"), params$pdf_mode, FALSE) 
 )
...
The source code is available at (https://github.com/ghobi20) and is powered by [nstrayer/cv](https://github.com/nstrayer/cv).
